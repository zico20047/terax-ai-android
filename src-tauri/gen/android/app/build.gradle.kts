...
android {
    compileSdk = 36
    namespace = "app.crynta.terax"

    signingConfigs {
        create("release") {
            storeFile = file("terax-release.keystore")
            storePassword = localProperties.getProperty("TERAX_STORE_PASSWORD", "")
            keyAlias = localProperties.getProperty("TERAX_KEY_ALIAS", "terax")
            keyPassword = localProperties.getProperty("TERAX_KEY_PASSWORD", "")
        }
    }

    defaultConfig {
        manifestPlaceholders["usesCleartextTraffic"] = "false"
        applicationId = "app.crynta.terax"
        minSdk = 24
